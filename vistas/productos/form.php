                    ...
                    enctype="multipart/form-data">
                      <fieldset>
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="Marca" required>
                                ...
                                <?php foreach($marcas as $m): ?>
                                    <option value="<?=$m->mar_id?>" 
                                        <?= $p->getPro_mar() == $m->mar_id ? 'selected' : '' ?>>
                                        <?=$m->mar_nom?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input required class="form-control" name="Cantidad" type="number"
                             placeholder="cantidad" value="<?=$p->getPro_can()?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="Imagen">Imagen</label>
                          <div class="col-lg-10">
                            <input required class="form-control" name="Imagen" type="file" placeholder="Cantidad" value="<?=$p->getPro_can()?>">
                          </div>
                        </div>
